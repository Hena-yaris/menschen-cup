...
//             isActive
//               ? "bg-yellow-600/20 text-yellow-400 font-bold border-b-2 border-yellow-500"
...
//   return (
//     <nav className="bg-gray-900 border-b border-yellow-500/30 text-white px-4 md:px-8 py-4 flex items-center justify-between shadow-2xl sticky top-0 z-50">
//       <h1 className="text-2xl md:text-3xl font-extrabold tracking-wider text-yellow-400">
//         Menschen <span className="text-white font-light">Cup</span>
//       </h1>
...
//       {/* Mobile Menu Button */}
//       <button
//         className="md:hidden text-yellow-400 hover:text-yellow-300 transition-colors duration-200"
...
//       <div
//         className={`md:hidden absolute top-full left-0 w-full bg-gray-900 border-t border-yellow-500/30 shadow-xl transition-all duration-300 ease-in-out overflow-hidden ${
